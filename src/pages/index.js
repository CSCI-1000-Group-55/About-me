    ...
    <div className='container'>
      ...
      <main>
        ...
        <div className='grid'>
          ...
          <a href='/nora ' className='card'>
            <h3>Nora's Page &rarr;</h3>
            <p>Click here to navigate to Nora's page</p>
          </a>

          <a href='/SiraajSandhu ' className='card'>
            <h3>Siraaj's Page &rarr;</h3>
            <p>Click here to navigate to Siraaj's page</p>
          </a>
